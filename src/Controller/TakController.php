...
class TakController extends AbstractController 
{
  ...
  public function generateTak($uid) {
		...
		if ($this->security->isGranted('ROLE_ADMIN')) {
			...
			if ($dataset) {
				...
				return $this->render('default/tak_generate.html.twig', ['displayName' => 'Dataset', 'uuid' => $uuid, 'dataset_uid' => $dataset->getId(), 'dataset_title' => $dataset->getTitle(), 'generated' => $tak->getGeneration()]);
  ...
  public function deleteTak($uuid) {
